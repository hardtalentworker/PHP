...
//***************************************************************** проверка на чётность, побитовая операция
  $x=8;
	if(($x&1)==0){
		echo ('чётное');
	}elseif(($x&1)==1){
...
//***************************************************************** вывод в файл всех констант и расширений подключенных  в PHP
	$file_extension='extension.txt';
...
//***************************************************************** //вычисление 200-го числа Фибоначчи
  $var=200;
	$n1=0;
	$n=1;
	for($i=3;$i<=$var;$i++){
